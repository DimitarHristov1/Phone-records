...
The project is made with Android Studio (IDE) Version: 2025.2.3. Used programing languages are: Java, XML, SQL, HTML. The data source for the app is made, via the helper class - "SQLiteOpenHelper", which is implemented in the IDE.
The minimum SDK for the project is 19, which means that the android version of the device has to be at least version 4.4 or higher, for the app to run.
<p><b>NOTE:</b> If you want to check out the files from the project, extract the archives: "Phone records - files vol. 1" and "Phone records - files vol. 2", from the folder: Phone records v1.0, v2.0 or v3.0, to your folder of liking.</p>

<h3>Changelog:</h3>
<h4><ins>Version 3.0</ins></h4>
<p>• Added a field "Additional information", for every contact. It is optitional, and can be left empty!</p>
<p>• Fixed bugs with the typing in the search field, when searching for a contact.</p>
<p>• Fixed bugs in how a contact will be stored in the database, when it is imported via a ".vcf" file.</p>
